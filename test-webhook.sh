...
# 模拟发送一个真实的飞书 webhook 消息
echo "📨 Simulating real Feishu webhook message..."
...
echo "  📨 Webhook event received from 127.0.0.1"
echo "  📋 Request headers: map[Content-Type:[application/json] ...]"
echo "  📝 Request body length: 1234"
echo "  🎯 Handler called with event: om_test_message_123"
echo "  📋 Event details: chatType=p2p, msgType=text"
